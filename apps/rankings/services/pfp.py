...
def serialize_pfp_ranking(ranking: CharacterRanking) -> dict:
    ...
    return {
        ...
        "player_name_corrupt": ranking.player.name_corrupt,
        "player_name_beskar": ranking.player.name_beskar,
        "player_name_particles": ranking.player.name_particles,
        "player_name_crack": ranking.player.name_crack,
