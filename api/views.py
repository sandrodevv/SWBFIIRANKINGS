            ...
            champions.append(
                {
                    ...
                    "player_name_corrupt": top.player.name_corrupt,
                    "player_name_beskar": top.player.name_beskar,
                    "player_name_particles": top.player.name_particles,
                    "player_name_crack": top.player.name_crack,
...
class PlayerDetailAPIView(APIView):
    ...
    def get(self, request, slug):
        ...
        payload = {
            ...
            "name_corrupt": player.name_corrupt,
            "name_beskar": player.name_beskar,
        ...
        votes = [
            {
                ...
                "player_name_corrupt": record.ranking.player.name_corrupt,
                "player_name_beskar": record.ranking.player.name_beskar,
                "player_name_particles": record.ranking.player.name_particles,
                "player_name_crack": record.ranking.player.name_crack,
